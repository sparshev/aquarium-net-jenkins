...
package ci.aquarium.net.pipeline;

import ci.aquarium.net.AquariumCloud;
import ci.aquarium.net.config.TemplateVariable;
        ...
        public ListBoxModel doFillTemplateIdItems() {
            ...
            for (hudson.slaves.Cloud cloud : Jenkins.get().clouds) {
                if (cloud instanceof AquariumCloud) {
                    ...
                    List<ci.aquarium.net.config.AquariumLabelTemplate> templates = aquariumCloud.getLabelTemplates();
                    if (templates != null) {
                        for (ci.aquarium.net.config.AquariumLabelTemplate template : templates) {
